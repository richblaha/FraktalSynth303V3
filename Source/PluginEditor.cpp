...
static constexpr int H    = 780;   // höher für Keyboard
...
static constexpr int SCOPE_Y = R2Y + RH + 6;
...
Fraktal611AudioProcessorEditor::~Fraktal611AudioProcessorEditor(){ stopTimer(); }
...
void Fraktal611AudioProcessorEditor::resized()
{
    ...
    osc1OctBox.setBounds  (SX0+PAD,       K1+26,   62, 20);
    osc1FOnBtn.setBounds  (SX0+PAD+66,    K1+26,   36, 20);
    osc1FHPBtn.setBounds  (SX0+PAD+106,   K1+26,   36, 20);
    // K2: PWM + VOL + CUT
    ...
    osc2OctBox.setBounds  (SX1+PAD,       K1+26,   62, 20);
    osc2FOnBtn.setBounds  (SX1+PAD+66,    K1+26,   36, 20);
    osc2FHPBtn.setBounds  (SX1+PAD+106,   K1+26,   36, 20);
