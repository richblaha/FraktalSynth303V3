...
private:
    ...
    const juce::Colour C_BG{0xFF0E0E0E},C_ACCENT{0xFFC8FF00},
    ...
    // ── Lorenz Navigator ─────────────────────────────────────────
    MidiLearnSlider lorenzSigmaKnob{processor,"lorenzSigma"};
    MidiLearnSlider lorenzRhoKnob  {processor,"lorenzRho"};
    MidiLearnSlider lorenzBetaKnob {processor,"lorenzBeta"};
    MidiLearnSlider lorenzDtKnob   {processor,"lorenzDt"};
    juce::Label lorenzSigmaLabel, lorenzRhoLabel, lorenzBetaLabel, lorenzDtLabel;

    // ── Gray-Scott RD Oscillator ──────────────────────────────────
    juce::ToggleButton gsOnBtn{"GS"};
    ...
    juce::Label     weiDimLabel;

    // ── Evolutionary Drift ────────────────────────────────────────
    juce::ToggleButton driftOnBtn{"DRIFT"};
    MidiLearnSlider driftSpeedKnob{processor,"driftSpeed"};
    MidiLearnSlider driftRangeKnob{processor,"driftRange"};
    juce::ComboBox  driftModeBox;
    juce::Label     driftSpeedLabel, driftRangeLabel;

    // ── Poly-Temporal LFO Multiplikatoren ─────────────────────────
    juce::ComboBox lfoMultBox, lfo2MultBox;
    juce::Label    lfoMultLabel, lfo2MultLabel;

    // ── Row 3 Attachments ─────────────────────────────────────────
    std::unique_ptr<SA> lorenzSigmaAttach, lorenzRhoAttach, lorenzBetaAttach, lorenzDtAttach;
    std::unique_ptr<SA> gsFeedAttach, gsKillAttach, gsDaAttach, gsDbAttach, gsVolAttach;
    std::unique_ptr<SA> weiDimAttach, driftSpeedAttach, driftRangeAttach;
    std::unique_ptr<CA> weiLacAttach, weiDepthAttach, driftModeAttach;
    std::unique_ptr<CA> lfoMultAttach, lfo2MultAttach;
    std::unique_ptr<BA> gsOnAttach, driftOnAttach;
